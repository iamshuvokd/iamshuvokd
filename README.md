<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&height=220&color=0:0F172A,45:0E7490,100:2563EB&text=Shuvo%20Kumar%20Das&fontColor=FFFFFF&fontSize=42&fontAlignY=38&desc=Senior%20Software%20Developer%20%7C%20Power%20Platform%20Specialist%20%7C%20Full-Stack%20Engineer&descAlignY=58&descSize=16" alt="Shuvo Kumar Das" />
</p>
...
I am a **Senior Software Developer** specializing in business applications, workflow automation, reporting systems, and full-stack product development. I combine practical software engineering with Microsoft Power Platform expertise to build solutions that are reliable, maintainable, and aligned with business operations.

My work focuses on turning complex processes into clean digital systems: internal applications, approval workflows, dashboards, integrations, data-driven tools, and modern web applications that teams can use with confidence.
...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Designing and delivering business-critical applications with clean data models, clear workflows, maintainable code, and user-focused interfaces.</p>
    </td>
    <td width="50%">
      <h3>Power Platform Architecture</h3>
      <p>Building scalable solutions with Power Apps, Power Automate, Power BI, SharePoint, Dataverse, and Microsoft 365 integrations.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>Automation & Integration</h3>
      <p>Reducing manual effort through workflow automation, API integrations, approval flows, scheduled processes, and structured data pipelines.</p>
    </td>
    <td width="50%">
      <h3>Full-Stack Engineering</h3>
      <p>Developing responsive frontends, reliable backends, database-backed features, dashboards, and production-ready technical documentation.</p>
    </td>
  </tr>
</table>
...
<p>
  ...
  <img src="https://img.shields.io/badge/SharePoint-03787C?style=for-the-badge&logo=microsoftsharepoint&logoColor=white" alt="SharePoint" />
  <img src="https://img.shields.io/badge/Dataverse-0B5563?style=for-the-badge&logo=microsoft&logoColor=white" alt="Dataverse" />
...
| Area | What I Deliver |
| --- | --- |
| Business Applications | Internal systems, operational tools, approval apps, data-entry workflows |
| Process Automation | Power Automate flows, scheduled jobs, notification systems, approval chains |
| Reporting & Analytics | Power BI dashboards, KPI tracking, management reports, decision-support views |
...
- I design systems around real user workflows and long-term maintainability.
- I prefer clear architecture, readable code, and practical delivery over unnecessary complexity.
- I use automation where it saves time, improves accuracy, or increases visibility.
- I document important decisions so teams can understand, operate, and improve the system.
- I care about reliable data, secure access, clean interfaces, and measurable business value.
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&height=120&section=footer&color=0:2563EB,55:0E7490,100:0F172A" alt="Footer" />
</p>
